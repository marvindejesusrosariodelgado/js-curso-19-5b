...
// Importamos para darle color a nuestros console.log() en terminal 
require('colors');
...
switch (command) {
    ...
    case 'create':
        // Comando create ejecutado creo una nueva nota en tasks.md
        let task = tasks.createTask(argv.title, argv.description)
        console.log("Tarea created: ".blue, task)
        break;

        case 'update':
        // Comando create ejecutado creo una nueva nota en mis tasks.md
